...
| **UC-H03**     | 在庫状況通知   | ❌   | ✅      | ・在庫切れ商品への通知登録率<br>・通知後の購入コンバージョン率<br>・特定商品の通知登録数（人気指標）<br>・入荷からの購入タイミング分布 | C-INVENTORY-01 |
...
| **UC-I03**     | 低在庫アラート   | ❌        | ✅      | ・アラート生成から確認までの時間<br>・アラート対応の完了率<br>・発注までの平均リードタイム<br>・低在庫による販売機会損失の推定 | A-INVENTORY-03 |
