# 1. AWS オブザーバビリティ学習用 eコマースアプリ - 自己評価チェックリスト
...
- [1. AWS オブザーバビリティ学習用 eコマースアプリ - 自己評価チェックリスト](#1-aws-オブザーバビリティ学習用-eコマースアプリ---自己評価チェックリスト)
  ...
  - [1.3. 各フェーズ終了時の成果物チェックリスト](#13-各フェーズ終了時の成果物チェックリスト)
    ...
    - [1.3.4. フェーズ4: 注文機能とオブザーバビリティ拡張 (週15-18)](#134-フェーズ4-注文機能とオブザーバビリティ拡張-週15-18)
      - [1.3.4.1. カート機能](#1341-カート機能)
      - [1.3.4.2. 注文処理](#1342-注文処理)
      - [1.3.4.3. イベント処理](#1343-イベント処理)
      - [1.3.4.4. エンドツーエンドオブザーバビリティ](#1344-エンドツーエンドオブザーバビリティ)
    - [1.3.5. フェーズ5: 管理機能と包括的モニタリング (週19-21)](#135-フェーズ5-管理機能と包括的モニタリング-週19-21)
      - [1.3.5.1. 商品管理機能の拡張](#1351-商品管理機能の拡張)
      - [1.3.5.2. 在庫管理システム](#1352-在庫管理システム)
      - [1.3.5.3. 包括的モニタリング](#1353-包括的モニタリング)
    - [1.3.6. フェーズ6: 本番環境と耐障害性 (週22-23)](#136-フェーズ6-本番環境と耐障害性-週22-23)
...
### 1.3.4. フェーズ4: 注文機能とオブザーバビリティ拡張 (週15-18)
...
### 1.3.5. フェーズ5: 管理機能と包括的モニタリング (週19-21)
